...
/// Color palette for yuva_worker app - professional twin of client app
/// - Primary: Soft aqua/teal (house body) - same as client
/// - Accent: Warm pastel yellow/gold (roof, broom, spray) - same as client
/// - Backgrounds: Slightly more neutral for data-heavy screens
class YuvaColors {
  YuvaColors._();
  ...
  // Neutral Colors - slightly more emphasis for worker app

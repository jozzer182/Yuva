...
import '../../data/models/client_notification.dart';
...
class _NotificationsScreenState extends ConsumerState<NotificationsScreen> {
  ...
  void _handleNotificationTap(ClientNotification notification) {
    // Marcar como leída
    _markAsRead(notification.id);

    // Navegar según el tipo
    switch (notification.type) {
      case ClientNotificationType.newMessage:
        ...
        break;
      case ClientNotificationType.newProposal:
      case ClientNotificationType.proposalStatusChange:
        if (notification.proposalId != null && notification.jobPostId != null) {
          // Navegar al detalle del trabajo (que muestra las propuestas)
          Navigator.push(
            context,
            MaterialPageRoute(
        ...
        } else if (notification.jobPostId != null) {
        ...
        break;
      case ClientNotificationType.jobStatusChange:
        ...
        break;
      case ClientNotificationType.genericInfo:
        // No navegar, solo mostrar
        break;
    }
  }

  IconData _getNotificationIcon(ClientNotificationType type) {
    switch (type) {
      case ClientNotificationType.newProposal:
  ...
  Color _getNotificationColor(ClientNotificationType type) {
    switch (type) {
      case ClientNotificationType.newProposal:
